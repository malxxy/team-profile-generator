function generateTeamProfile(data) {
    console.log(data); // data = the teamMembers array 
    // iterate through array and create a card for each team member
    return `<!DOCTYPE html>
            ...
            <div class="text-white bg-primary border rounded border-0 p-4 py-5" style="opacity: 1;padding: 10px;">
                <div class="container py-4 py-xl-5">
                    ...
                    <div class="row gy-4 row-cols-1 row-cols-md-2 row-cols-xl-3">
                     ${data.map(employee => createCard(employee))}  
                    </div>
                </div>
            </div>
    ...
    return `<div class="col">
        <div class="text-center d-flex flex-column align-items-center align-items-xl-center">
            ...
            <div class="px-3">
                ...
                <p>${role}</p>
                <ul class="list-group">
                    <li class="list-group-item"><span>ID: ${employee.id};</span></li>
                    <li class="list-group-item"><span>Email: ${employee.email};</span></li>
                    ${role === 'Manager' ? `<li class="list-group-item"><span>Office number: ${employee.officeNumber}</span></li>`
                    : role === 'Engineer' ? `<li class="list-group-item"><span>GitHub: ${employee.GitHub}</span></li>`
                    : `<li class="list-group-item"><span>School: ${employee.school};</span></li>`}
                </ul>
            </div>
        </div>
    </div>`
...
//   Ternary operator ? : (else or else if, always must end in colon to indicate else)